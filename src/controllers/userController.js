...
import { smsService } from '~/providers/TwilioSmsProvider'
...
const register = async (req, res) => {
  try {
    ...
    // ========= Approach 3: Usage Twilio for send SMS
    const messageSms = await smsService.send({
      to: process.env.TWILIO_PHONE_NUMBER_REGISTERED,
      body: 'Created account successfully. Welcome to my platform'
    })
    console.log('Twilio service: Send SMS response: ', messageSms)
